...
for n = 1 : save_image_num
    image_file_name = ['./' folder_name '/image_' num2str(n) '.tif']
    ...
    imwrite(cut_temp_image, image_file_name);
    manualCreatMask( cut_temp_image,  image_file_name);
    pause(5)
